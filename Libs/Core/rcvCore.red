...
"Loads image from file and specifies the type of image"
	fileName 	[file!]  ; [bmp png jpeg gif]
	type		[word!]			
][
...
"Returns pixel value at xy coordinates as integer"
    ...
    pix1: image/acquire-buffer src as ptr-ptr! :handle
...
"Set pixel value at xy coordinates"
    ...
    handle/value: as int-ptr! 0
    pix: image/acquire-buffer src as ptr-ptr! :handle
    w: IMAGE_WIDTH(src/size)
    pos: (coordinate/y * w) + coordinate/x
    pix: pix + pos
    pix/value: (a << 24) or (r << 16) or (g << 8) or b
    image/release-buffer src handle/value yes
]
...
"General routine for logical operators on image"
	...
	handleD/value: as int-ptr! 0
	pix1: image/acquire-buffer src1 as ptr-ptr! :handle1
	pix2: image/acquire-buffer src2 as ptr-ptr! :handle2
	pixD: image/acquire-buffer dst as ptr-ptr! :handleD
	...
	image/release-buffer src1 handle1/value no
	image/release-buffer src2 handle2/value no
	image/release-buffer dst handleD/value yes
]
...
rcvMerge: routine [
    ...
    /local
        ...
        handle3 handleD [ptr-value!]
        n i				[integer!]
        r g b a			[integer!]
][
    handle1/value: as int-ptr! 0
    handle2/value: as int-ptr! 0
    handle3/value: as int-ptr! 0
    handleD/value: as int-ptr! 0
    pix1: image/acquire-buffer src1 as ptr-ptr! :handle1
    pix2: image/acquire-buffer src2 as ptr-ptr! :handle2
    pix3: image/acquire-buffer src3 as ptr-ptr! :handle3
    pixD: image/acquire-buffer dst as ptr-ptr! :handleD
    n: IMAGE_WIDTH(src1/size) * IMAGE_HEIGHT(src1/size)
    pixel: [(a << 24) OR (r << 16 ) OR (g << 8) OR b]
    i: 0
    ...
    image/release-buffer src1 handle1/value no
    image/release-buffer src2 handle2/Value no
    image/release-buffer src3 handle3/value no
    image/release-buffer dst handleD/value yes
]
...
"Merge 4 images to destination image"
    ...
    handle2/value: as int-ptr! 0
    handle3/value: as int-ptr! 0
    handle4/value: as int-ptr! 0
    handleD/value: as int-ptr! 0
    pix1: image/acquire-buffer src1 as ptr-ptr! :handle1
    pix2: image/acquire-buffer src2 as ptr-ptr! :handle2
    pix3: image/acquire-buffer src3 as ptr-ptr! :handle3
    pix4: image/acquire-buffer src4 as ptr-ptr! :handle4
    pixD: image/acquire-buffer dst as ptr-ptr! :handleD
    pixel: [(a << 24) OR (r << 16 ) OR (g << 8) OR b]
    n: IMAGE_WIDTH(src1/size) * IMAGE_HEIGHT(src1/size)
    i: 0
    ...
    image/release-buffer src2 handle2/value no
    image/release-buffer src3 handle3/value no
    image/release-buffer src4 handle4/value no
    image/release-buffer dst handleD/value yes
]
