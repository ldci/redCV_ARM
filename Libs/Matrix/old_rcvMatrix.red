...
rcvGetIntValue: routine [
	p		[byte-ptr!] ; address of mat element as integer
...
rcvSetIntValue: routine [
	...
	unit	[integer!] ; size of integer 8 16 32 [1 2 4]	
     ...
     p/value: switch unit [
			1 [value and FFh or (p/value and FFFFFF00h)]
			2 [value and FFFFh or (p/value and FFFF0000h)]
			4 [value]
	]
]
...
"Get integer matrix value"
	...
	vec: mat/get-data mObj					;--OK
	unit: mat/get-unit mObj					;--OK
	width: mat/get-cols mObj				;--OK
	mvalue: vector/rs-head vec	;--OK
    ...
    while [y < h] [
    	x: 0
       	while [x < w][
        	...
        	rcvSetIntValue dvalue rgb unit
           	x: x + 1
           	pix1: pix1 + 1
           	dValue: dValue + unit
       	]
