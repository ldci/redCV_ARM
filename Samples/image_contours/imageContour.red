...
view win: layout [
		...
		button 60 "Quit" [	rcvReleaseImage img1 
							...
							Quit]
		return
		text "Source" middle f5: field 165 ;pad 174x0 
		text "Surface" middle f6: field 165; pad 174x0
		text "Perimeter" middle f7: field 170
		return
		...
		return
		pad 35x0
		text 80 "Top Left" middle f1: field 80
		text 80 "Top Right" middle f2: field 80
		text 80 "Bottom Left" middle f3: field 80
		text 80 "Bottom Right" middle f4: field 80
		return
		r: area 788x100 wrap
]
