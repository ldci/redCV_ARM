...
view win: layout [
	...
	button "Quit" [Quit]
	return
	text 100 green "Image 1" middle f1: field 100 pad 36x0
	text 100 red  "Image 2" middle f2: field 100 pad 60x0
	text 120 "Shapes Signature" middle pad 270x0
	text "Optimum Warping Path" middle 
	return
