...
win: layout [
	...
	button "Quit"			[Quit]
	return
	text 55 "Euclidian" middle
	f5: field 50
	text 35 "DTW" middle
	f6: field 50
	sl: slider 200x25 [dMin: to-integer sl/data * 1023 f4/text: form dMin
