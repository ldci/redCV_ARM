...
view win: layout [
	...
	text 75 "Sample" middle
	f1: field 80 "1 000 000" [if error? try [n: to-integer face/text] [n: NMAX]]
	text 50 "STD" middle	 
	f2: field 40 "1.0" [if error? try [std: to-float face/text] [std: 1.0]]
	...
	return
	sb: field 640
	text 200 center middle "© Red Foundation 2019"
	do [f1/text: form n]
]	
