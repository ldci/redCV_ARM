...
view win: layout [
		...
		return
		text 130x20 "Sobel Direction" middle
		...
		r3:	radio  60 "X+Y" 	[param: 3 if isFile [rcvSobel cImg dst param op]]
		r4:	radio "Magnitude" 	[param: 4 if isFile [rcvSobel cImg dst param op]]
		r5: radio 65 "Angles"	[param: 5 if isFile [rcvSobel cImg dst param op]]
