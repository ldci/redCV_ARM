...
view win: layout [
		...
		text 100 " Radius" middle
		sl: slider 200x25 [radius: 48.0 - to-float (face/data * 48.0)
		...
		button 60 "Quit" [	rcvReleaseImage img0
							...
							Quit]
		return
		text "Source Image" 200 middle
		pad 56x0 
		text "Grayscale" 200 middle
		pad 56x0 
		text "Low-Pass Filtering" 200 middle
		pad 56x0 
		text "Fourier Filtered Image" middle
		return
		...
		return
		text 512 "© Red Foundation 2019" middle center
		pad 10x0
		sb: field 522
