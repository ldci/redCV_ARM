...
view win: layout [
	...
	text 40 bold "Noise" middle
	sl: slider 50x25 [noise: to-float face/data f/text: form round/to noise 0.01 noiseGenerator]
	f: text bold 50 "0.0" middle
	text 40 bold "Red:" middle
	slR: slider 50x25 [r: to-integer slR/data * 255  fr/text: form r color/1: r] 
	fr: text 30 bold right "0" middle
	text 50 bold "Green:" middle
	slG: slider 50X25 [g: to-integer slG/data * 255  
					fg/text: form g color/2: g] 
	fg: text 30 bold right "0"
	text 40 bold "Blue:" middle
	slB: slider 50x25 [b: to-integer slB/data * 255  
