...
view [
	...
	return
	; lower tupple
	txt "1 [R/H]:" lrSl: slider 256x25 value react [face/text: to-text lrSl/data] return
	txt "2 [G/S]:" lgSl: slider 256x25 value react [face/text: to-text lgSl/data] return
	txt "3 [B/V]:" lbSl: slider 256x25 value react [face/text: to-text lbSl/data] 
	pad 0x-65 box1: base 150x90 react [face/color: to-color lrSl/data lgSl/data lbSl/data] return
	
	;upper tupple
	txt "1 [R/H]:" urSl: slider 256x25 value react [face/text: to-text urSl/data] return
	txt "2 [G/S]:" ugSl: slider 256x25 value react [face/text: to-text ugSl/data] return
	txt "3 [B/V]:" ubSl: slider 256x25 value react [face/text: to-text ubSl/data] 
