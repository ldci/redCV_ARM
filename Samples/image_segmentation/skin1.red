Red [
	Title:   "Red Computer Vision: Segmentation"
	Author:  "ldci"
	File: 	 %skin1.red
	Tabs:	 4
...
#include %../../libs/imgproc/rcvSegmentation.red
threshold: 15
iSize: 512x512
...
mainWin: layout [
	...
	text "Threshold" 
	sl: slider 100x25 [threshold: 1 + to-integer face/data * 63 tF/text: form threshold 
					rcvSkinColor img dst threshold]
	tF: field 50 "15" 			
	pad 600x0		
	button "Quit" [Quit]
