...
view layout [
	...
	text 40 "Angle" middle fa: field 30
	text 30 "Cos" middle  fc: field 50
	text 30 "Sin" middle  fs: field 50
	text 30 "Tan" middle  ft: field 50
	return 
	text 40 "Angle" middle fp: field 30
	text 30 "AB" middle	fpc: field 50
	text 30 "AC" middle	fpb: field 50
	text 30 "BC" middle	fpa: field 50
	return 
	base 400x1 blue return
