...
view win: layout [
		...
		sl: slider 255x25 [thresh: 1 + to-integer face/data * 127
						ft/text: form thresh
						rcvHarris imgX imgY dst k thresh
						canvas3/image: dst ]
		ft: field 50 "127" 
		...
		return
		text 128 "Source" middle
		text 128 "X direction" middle
		text 128 "Y direction" middle
		text 512 "Harris corner detection" middle
		return
