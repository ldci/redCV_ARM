...
view win: layout [
	...
	sl1: slider 150x25 	[thresh: 1 + to integer! face/data * 512 f/text: form thresh drawLines]
	f: field 50 "32" 	[if error? try [thresh: to-integer face/text] [thresh: thresh] 
						sl1/data: to-percent to-float thresh / 512.0
						drawLines]
	ff: field 50
	pad 80x0
	text "Contrast" middle
	sl2: slider 150x25 	[contrast: 1.0 + to float! (face/data * 25.0) cf/text: 
