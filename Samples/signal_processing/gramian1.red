...
img2Size: 360x360
sSize: img1Size/x
img1: rcvCreateImage img1Size
img2: rcvCreateImage img2Size
signal: none
op: 1
...
processSignal: does [
	...
	img2: 	rcvCreateImage img2Size
	probe 1
	rcvMat2Image gMat img2
	probe 2; length? gMat/data
	canvas2/image: img2
]
...
view win: layout [
	...
	button "Quit" 				[Quit]
	return
	canvas1: base img1Size img1
	return
	canvas2: base img2Size img2
]
