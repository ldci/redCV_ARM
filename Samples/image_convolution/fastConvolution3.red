...
view win: layout [
	...
	text 100 "Multiplier" middle
	sl1: slider 200x25 [factor: 0.5 + (face/data * 19.5) 
		f1/data: form to integer! factor
		if isFile [convolve]
	]
	f1: field 50 "0"
	text 100 "Brightness" middle
	sl2: slider 200x25 [delta: 0.0 + (face/data * 256.0) 
	...
	return
	text 100 "Source"
	pad 156x0 text "Channel 1: R" middle
	pad 176x0 text "Channel 2: G" middle
	pad 176x0 text "Channel 3: B" middle
	pad 170x0 text "RGB Filtered" middle
	return
	canvas1: base isize
	canvas2: base isize
	canvas3: base isize
